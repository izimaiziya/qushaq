/* ============================================================
   Qushaq — localized data
   Article library, work jobs and chat-response templates,
   provided per language (ru / en / kk). Content driven by
   CURRENT_LANG from i18n.js.
   ============================================================ */
...
/* ---------- PROFILE_RULES: kept multilingual for matching user free text ---------- */
const PROFILE_RULES = [
...
/* ---------- Onboarding chip -> canonical diagnosis id, shared across langs ---------- */
...
/* ---------- Work jobs (freelance / gig board demo) ---------- */
...
/* ---------- Chat response templates (rule-based demo assistant) ---------- */
const RESP_BY_LANG = {
ru: {
