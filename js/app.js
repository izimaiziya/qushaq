...
(function () {
  ...
  function update() {
    ...
    // Past this point the interactive app demo has its own nav pill —
    // keep the floating header out of the way so the two never overlap.
    const inDemoZone = demoBoundary && (y + 80) >= demoBoundary.getBoundingClientRect().top + window.scrollY;
